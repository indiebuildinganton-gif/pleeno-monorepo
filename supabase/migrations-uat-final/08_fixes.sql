-- ======================================
-- Migration 8: Various Fixes and Updates
-- ======================================

BEGIN;

-- Various fixes and schema updates

-- Source: 005_fixes/001_fix_schema_mismatches.sql
...
-- Source: 007_student_payment_history/001_get_student_payment_history_function.sql
