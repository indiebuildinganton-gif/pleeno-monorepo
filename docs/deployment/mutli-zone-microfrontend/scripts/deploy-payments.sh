...
# Deploy Payments App to Vercel
# Usage: ./deploy-payments.sh
...
APP_NAME="Payments"
PROJECT_NAME="pleeno-payments-uat"
APP_PATH="apps/payments"
...
main() {
    ...
    log_success "Environment variable deployed: NEXT_PUBLIC_PAYMENTS_URL"
    log_success "Test at: https://plenno.com.au/payments"
}
