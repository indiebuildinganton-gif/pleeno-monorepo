...
# Deploy Reports App to Vercel
# Usage: ./deploy-reports.sh
...
APP_NAME="Reports"
PROJECT_NAME="pleeno-reports-uat"
...
main() {
    ...
    log_success "Environment variable deployed: NEXT_PUBLIC_REPORTS_URL"
    log_success "Test at: https://plenno.com.au/reports"
}
