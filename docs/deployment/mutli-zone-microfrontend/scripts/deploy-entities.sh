...
# Deploy Entities App to Vercel
# Usage: ./deploy-entities.sh
...
APP_NAME="Entities"
PROJECT_NAME="pleeno-entities-uat"
APP_PATH="apps/entities"
...
main() {
    ...
    log_success "Environment variable deployed: NEXT_PUBLIC_ENTITIES_URL"
    log_success "Test at: https://plenno.com.au/entities"
}
