...
**Subtasks:**
1. Create packages/validations/src/invitation.schema.ts
2. Define InvitationCreateSchema: email, role, task_ids
3. Define UserTaskAssignmentSchema: task_ids (array of UUIDs)
4. Validate email format
5. Validate role enum ('agency_admin', 'agency_user')
6. Validate task_ids are valid UUIDs
...
1. The acceptance criteria (AC: 1, 5)
