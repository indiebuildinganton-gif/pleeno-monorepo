...
import { Download, Trash2, Eye, EyeOff, Activity, X } from 'lucide-react'
  ...
  if (!isOpen) {
    return (
      ...
      >
        ...
        {logs.length > 0 && (
          <span className="absolute top-0 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-blue-600 rounded-full min-w-[18px]">
